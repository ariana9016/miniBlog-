                  ...
                  <button
                    onClick={() => {
                      setConfirmModal({
                        ...
                        message: u.isBanned 
                          ? `Are you sure you want to unban ${u.name}? This will restore their access to the platform.`
                          : `Are you sure you want to ban ${u.name}? This will prevent them from accessing the platform and delete all their posts and comments.`,
                        onConfirm: () => handleBanUser(u._id),
                        confirmText: u.isBanned ? 'Unban' : 'Ban',
                        confirmButtonClass: u.isBanned ? 'btn-confirm' : 'btn-danger'
                      });
                    }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        setConfirmModal({
                          isOpen: true,
                          title: 'Ban Author',
                          message: `Are you sure you want to ban ${p.author.name}? This will prevent them from accessing the platform and delete all their posts and comments.`,
                          onConfirm: () => handleBanPostAuthor(p.author._id),
                  ...
                  <button
                    ...
                    onClick={() => {
                      setConfirmModal({
                        ...
                        onConfirm: () => handleDeletePost(p._id),
                        confirmText: 'Delete',
                        confirmButtonClass: 'btn-danger'
                      });
                    }}
